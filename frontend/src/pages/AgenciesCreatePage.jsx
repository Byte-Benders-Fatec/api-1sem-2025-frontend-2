...
export default function AgenciesCreatePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API_BASE_URL}/agencies`, payload, {
        headers: {
      ...
      console.error(err)
      setError('Erro ao criar agência.')
    }
  }

  return (
    <div>
      <h2 className="text-xl font-bold text-green-700 mb-4">Criar Agência Financiadora</h2>
